...
<div class="max-w-xl mx-auto relative z-10">
    ...
    <!-- 🟢 เพิ่มปุ่มย้อนกลับไปหน้าหลัก index.php (วางไว้ด้านบนสุด ซ้ายมือ) -->
    <div class="mb-4">
        <a href="index.php" class="inline-flex items-center text-sm font-bold text-slate-500 hover:text-sky-600 bg-white border border-slate-200 hover:border-sky-300 px-4 py-2 rounded-xl transition-all shadow-xs">
            <i class="fas fa-arrow-left mr-2 text-sky-500"></i> กลับหน้าหลัก
        </a>
    </div>
